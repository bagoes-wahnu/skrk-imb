              ...
              <div class="card-body">
                <div id="modal-table1" class="table-responsive">
                  <table class="table">
                    ...
                    <tr>
                      <th>Tanggal SKRK</th>
                      <td>{{ $aspects->tgl_skrk }}</td>
                    </tr>
                    <tr>
                      <th>Nama Pemohon SKRK</th>
                      <td>{{ $aspects->pemohon }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <th>File SKRK</th>
                      <td><a href="{{asset("storage/scan_skrk/$aspects->scan_skrk")}}" target="_blank">{{ $aspects->scan_skrk }}</a></td>
                    </tr>
                    <tr>
                      <th>File Zoning</th>
                      <td><a href="{{asset("storage/scan_zoning/$aspects->scan_zoning")}}" target="_blank">{{ $aspects->scan_zoning }}</a></td>
                    </tr>
                    <tr>
                      <th>File IMB</th>
                      <td><a href="{{asset("storage/scan_imb/$aspects->scan_imb")}}" target="_blank">{{ $aspects->scan_imb }}</a></td>
                    </tr>
                    <tr>
